...
export default function App() {
  ...
  return (
    <>
      <div className="bg-[#F7F5F3] font-sans text-[#1A1A1A] overflow-x-hidden selection:bg-[#E17A5D] selection:text-white">

        {/* --- NOVA NAVBAR (Substituindo o Header antigo) --- */}
        <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 px-6 md:px-16 lg:px-32 ${scrolled ? "bg-[#F7F5F3]/80 backdrop-blur-lg shadow-sm py-4" : "bg-transparent py-8" }`}>
          ...
          {mobileOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-[#F7F5F3] border-b border-[#E8E6E4] px-6 py-2">
        ...
        <section className="relative flex items-start pt-24 px-6 md:px-16 lg:px-32">
          {/* md:block - max-w-[1000px] */}
          <img
            src={NatAmarela}
            className="hidden md:block absolute top-0 right-0 z-0 pointer-events-none w-1/2 max-w-[800px] h-auto object-contain"
            // style={{ width: '50%' }}
            alt=""
          />
        ...
        {/* 2. Secção Sobre Mim - md:py-24 */}
        <section id="sobre" className="relative flex items-center justify-center py-16 lg:mt-40 px-6 bg-[#F7F5F3]">
        ...
        {/* 3. SEÇÃO PROJETOS */}
        <section id="projetos" className="relative pt-5 pb-5 px-6 lg:px-32 bg-[#F7F5F3]">
