...
{/* 2. Secção Sobre Mim */}
<section id="sobre" className="relative min-h-screen flex items-center justify-center py-32 md:py-48 px-6 bg-[#F7F5F3]">
  ...
  <div className="z-10 grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 w-full max-w-7xl mx-auto items-center">
    ...
    <div className="flex flex-col space-y-10">
      ...
      <div className="grid grid-cols-2 gap-6 pt-6 font-sans">
        ...
        {/* 3. SEÇÃO PROJETOS */}
        <section id="projetos" className="relative py-24 px-6 md:px-16 lg:px-32 bg-[#000000]">
                 ...
                 <SwiperSlide key={index}>
                    <div className="group bg-white rounded-[32px] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col h-full border border-[#EEECEA]">
                       ...
                       <div className="p-8 flex flex-col grow text-left">
                          ...
                          <button className="text-[#E17A5D] font-bold text-sm flex items-center gap-2 hover:gap-3 transition-all">Ver detalhes →</button>
                       </div>
                    </div>
                 </SwiperSlide>
               ))}
